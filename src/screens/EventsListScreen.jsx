...
import { mockEvents, mockCart } from '../data/mock';
      ...
      <main className="events-list__content">
        {filtered.length > 0 ? (
              ...
              <li key={event.id}>
                <article className="event-card">
                  ...
                  <div className="event-card__body">
                    ...
                    <h2 className="event-card__artist">{event.artist}</h2>
          ...
          <div className="events-list__empty">
            ...
            <p className="events-list__empty-sub">Try a different artist, venue, or city.</p>
